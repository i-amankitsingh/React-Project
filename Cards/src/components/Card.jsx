...
const Card = ({ img, text, state, degree }) => {
  ...
  return (
    <>
      <div className={`w-[400px] absolute bg-gray-100 p-5 shadow-md bg-[url(images/paper.png)] flex flex-col justify-center items-center select-none hover:z-50`}
        style={{
      ...
      >
        ...
        <div className="group w-full h-[400px] mt-5 flex justify-center items-center relative">
